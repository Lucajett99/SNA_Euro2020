...
\begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth]{../Subs/imgWithSubs/Spain_Network_Spain_Sweden.png}
...
\begin{figure}%
        \centering
        \subfloat[\centering Spain-Poland]{{\includegraphics[width=0.4\textwidth]{../Subs/imgWithSubs/Spain_Network_Spain_Poland.png} }}%
        \qquad
        \subfloat[\centering Switzerland-Spain]{{\includegraphics[width=0.4\textwidth]{../Subs/imgWithSubs/Spain_Network_Switzerland_Spain.png} }}%
        \label{fig:example}%
    \end{figure}
...
\begin{figure}%
        \centering
        \subfloat[\centering Poland in  Spain-Poland]{{\includegraphics[width=0.4\textwidth]{../Subs/imgWithSubs/Poland_Network_Spain_Poland.png} }}%
        \qquad
        \subfloat[\centering Russia in Russia-Denmark]{{\includegraphics[width=0.4\textwidth]{../Subs/imgWithSubs/Russia_Network_Russia_Denmark.png} }}%
        \label{fig:example}%
    \end{figure}
